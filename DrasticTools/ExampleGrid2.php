...
var thegrid = new drasticGrid('grid1', {
	pathimg: "img/"
/*	columns: [
		{name: "id", type: DDTYPEINT, displayname: "eerstetttt", width: 40},
		{name: "Code", type: DDTYPECHAR, displayname: "twee", editable: false},		
		{name: "Name", type: DDTYPECHAR, editable: true},				
		]
*/
	});
</script>
