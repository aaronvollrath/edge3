...
<?
	...
	$sql = "SELECT ProbeUID, ProbeName, GeneSymbol, SystematicName, Description FROM agilent015354_extendedannotations WHERE FeatureNum = $featurenum";
}
#echo "<br>$sql<br>";
$sqlResult = mysql_query($sql, $db);
$row = mysql_fetch_row($sqlResult);
...
<?php
		...
		$seqSQL = "SELECT Sequence, Refseq, GenBankAcc, LocusLinkID, UnigeneID, EnsemblID, TigrID, ChromosomalLocation, Cytoband, GoID FROM agilent015354_extendedannotations WHERE ProbeName = \"$ProbeName\"";
		//echo "$seqSQL<br>";
