...
public class Cluster {
    ...
    // Values added for single channel clustering....
    static float maxUnitsValue;
    static float minUnitsValue;
    static float medUnitsValue;
  ...
  public void plotCluster(int k, int orderedNumber) {
        ...
        try {
            ...
            String dataset = Cluster.filenum;
                ...
                ".php";
		String mxmlFile = "./IMAGES/chart" + dataset + "cluster" + orderedNumber + ".mxml";
