...
?>
	<a href="./agilentarrayadmin.php">Enter Another?</a>
<?php
	analyze($_POST);
	#analyze($_FILES);
...
?>
<p>
	This form is used to modify an existing array.  It will take a data file and replace it with a different one.  <br>
	Please be cognizant of the control channel.
</p>

	<form enctype="multipart/form-data" name="newagilentsample" action="agilentarrayadmin.php" method="post">
...
//  Need to check to see if the name already exists in the database...
	...
	//echo "$namesql<br>";
		echo "<b><font color=\"red\">this name already exists in the database.  please reenter the array</font><br>link: <a href='agilentarrayadmin.php'>go back to entry page</a>";
		exit(0);
	}*/
...
//echo "$command<br>";
	...
	if ($my_uploader->error) {
		...
		*/
		...
		/*echo "<h3>inputfilename = $inputfilename</h3>";
	...
	/*
		...
		if($affectedrows==-1){
			...
			echo "<font color=\"green\"><strong>Data successfully entered into database!</strong></font><br><a href='agilentarrayadmin.php'>Click to enter another array</a>";
		}
