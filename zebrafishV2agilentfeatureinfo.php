...
<?
	...
	$sql = "SELECT ProbeUID, ProbeName, GeneSymbol, SystematicName, Description FROM agilent019161_extendedannotations WHERE FeatureNum = $featurenum";
}
#echo "<br>$sql<br>";
$sqlResult = mysql_query($sql, $db);
$row = mysql_fetch_row($sqlResult);
...
$ProbeName = str_replace('"', "", $ProbeName);
		$seqSQL = "SELECT Sequence, Refseq, GenBankAcc, LocusLinkID, UnigeneID, EnsemblID, TigrID, ChromosomalLocation, Cytoband, GoID FROM agilent019161_extendedannotations WHERE FeatureNum = $featurenum";
		#echo "$seqSQL<br>";
