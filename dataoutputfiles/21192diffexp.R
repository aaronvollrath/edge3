...
library(genefilter)
library(multtest)
targets <- readTargets(file="c:/xampp/htdocs/edge3/dataoutputfiles/targets21192.txt")
...
eb<-eBayes(fit2)
cat("<h1>Results</h1>", file="c:/xampp/htdocs/edge3/dataoutputfiles/21192.html", append=TRUE)
cat("<div id='tabs' style='width: 700px; float:left'><ul>", file="c:/xampp/htdocs/edge3/dataoutputfiles/21192.html", append=TRUE)
cat("<li><a href=\"#fragment-1\"><span>corn oil vs tcdd</span></a></li>", file="c:/xampp/htdocs/edge3/dataoutputfiles/21192.html", append=TRUE)
cat("</ul>", file="c:/xampp/htdocs/edge3/dataoutputfiles/21192.html", append=TRUE)
cat("<div id=\"fragment-1\">", file="c:/xampp/htdocs/edge3/dataoutputfiles/21192.html", append=TRUE)
# GET THE TOP TABLE FOR coef #$
options(digits=3)
tt<-topTable(eb,coef=1,n=nrow(dat.m), adjust="fdr",genelist=fit$genes)
write.table(tt,sep="	",file="c:/xampp/htdocs/edge3/dataoutputfiles/21192orderedgenes_1.txt",quote=FALSE,row.names=FALSE)
rn<-rownames(tt)[tt$P.Value<=0.01]
dat.s<-dat.m[rn,]
write.table(dat.s,sep="	",file="c:/xampp/htdocs/edge3/dataoutputfiles/21192genelist_1.txt",quote=FALSE,row.names=TRUE,col.names=TRUE)
...
png(file="c:/xampp/htdocs/edge3/dataoutputfiles/21192coloredvolcanoplot1.png", width=800,height=800)
...
dev.off()
ttcolnames <- names(tt)
cat("The ",numberofsignificantvalues, " genes designated as being differentially expressed; sorted by B-statistics.<br> ", file="c:/xampp/htdocs/edge3/dataoutputfiles/21192.html", append=TRUE)
cat("Here is the file containing all of the ranked genes: <a href='./dataoutputfiles/21192orderedgenes_1.txt' target='_blank'>corn oil vs tcdd</a><br>", file="c:/xampp/htdocs/edge3/dataoutputfiles/21192.html", append=TRUE)
cat("Here is a file containing the differentially expressed genes: <a href='./dataoutputfiles/21192genelist_1.txt' target='_blank'>corn oil vs tcdd differentially expressed</a><br>",file="c:/xampp/htdocs/edge3/dataoutputfiles/21192.html", append=TRUE)
cat("Save the set of differentially expressed genes as a EDGE<sup>3</sup> gene list? <a href='./phpinc/importgenelistresult.inc.php?type=0&featurefilenumber=21192&querytype=1&contrastnumber=1&name=corn oil vs tcdd' target='_blank'>Save gene list</a><br>", file="c:/xampp/htdocs/edge3/dataoutputfiles/21192.html",append=TRUE)
cat("<table width=600 border='1' frame='border' rules='none'>", file="c:/xampp/htdocs/edge3/dataoutputfiles/21192.html", append=TRUE)
cat("<tr bgcolor='ddddff'>", file="c:/xampp/htdocs/edge3/dataoutputfiles/21192.html", append=TRUE)
for(j in 1:ncol(tt)){
	cat("<td align='center'><b>",ttcolnames[j],"</b></td>",file="c:/xampp/htdocs/edge3/dataoutputfiles/21192.html",append=TRUE)
	}
cat("</tr>",file="c:/xampp/htdocs/edge3/dataoutputfiles/21192.html",append=TRUE)
#Get the rownames (i.e., genes and feature numbers) from tt
ttrownames = rownames(tt)
for(i in 1:numberofsignificantvalues){
cat("<tr bgcolor=''>", file="c:/xampp/htdocs/edge3/dataoutputfiles/21192.html", append=TRUE)
...
",featurenum,"' target='_blank'>",featurename,"</a></td>",file="c:/xampp/htdocs/edge3/dataoutputfiles/21192.html",append=TRUE)
for(j in 1:ncol(tt)){
		cat("<td>",tt[i,j],"</td>",file="c:/xampp/htdocs/edge3/dataoutputfiles/21192.html",append=TRUE)
}
cat("</tr>",file="c:/xampp/htdocs/edge3/dataoutputfiles/21192.html",append=TRUE)
}
cat("</table>", file="c:/xampp/htdocs/edge3/dataoutputfiles/21192.html", append=TRUE)
cat("<h2>Volcano Plot</h2>", file="c:/xampp/htdocs/edge3/dataoutputfiles/21192.html", append=TRUE)
cat("<img src='./dataoutputfiles/21192coloredvolcanoplot1.png'><p>", file="c:/xampp/htdocs/edge3/dataoutputfiles/21192.html", append=TRUE)
cat("</div>", file="c:/xampp/htdocs/edge3/dataoutputfiles/21192.html", append=TRUE)
